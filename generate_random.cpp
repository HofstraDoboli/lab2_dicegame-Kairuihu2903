...
int main()
{
    ...
    */
    ...
    answer = "the output of rand() is ten random numbers between 0 to RAND_MAX, RAND_MAX is a constant interget that is already defined bythe cstdlib" ; // 1. Write your answer to Q1 in between " "
    ...
    answer = "% means modulo and the answer that will be provided will be the remainder of the division between two numbers, thus the output of rand()%5 will be the remainder of the divison between a random number and 5 and thus will be between 0-5" ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "the output of rand()%5+3 is the remainder of the division between a random number and 5, after this the remainder is added with 3 thus providing a number between 3-7" ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "srand(time(NULL)) assigns the current time to the seed which allows the seed to progress, without the srand(time(NULL)) the seed does not progress thus the result is the randomly generated numbers will stay the same because there is no change to the state of the machine" ; // 4. Write your answer to Q4 in between " "
